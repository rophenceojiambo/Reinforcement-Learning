...
[DQN file](). We used the same train/test splits as in the previous sections. We build some of the code used in this section from [Analytics Vidhya](https://www.analyticsvidhya.com/blog/2021/01/bear-run-or-bull-run-can-reinforcement-learning-help-in-automated-trading/), but tailored it to serve the needs of our project.
